...
INSERT INTO `meimei-prisma`.`sys_notice` (`noticeId`,`noticeTitle`,`noticeType`,`noticeContent`,`status`,`createBy`,`createTime`,`updateBy`,`updateTime`,`remark`,`warningLevel`) VALUES (1, '测试一个小公告', '1', 0x3C703EE6B58BE8AF95E4B880E4B88BE585ACE5918A2E2E2E2E2E2020203C2F703E, '0', 'admin', '2024-05-17 13:50:01', '', NULL, NULL,'严重')
;
UNLOCK TABLES;
COMMIT;
BEGIN;
